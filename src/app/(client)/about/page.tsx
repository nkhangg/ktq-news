                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-5">
                    <div className="flex flex-col justify-between h-full gap-5">
                        <BoxAboutSession icon={Sparkle} title={`Sứ mệnh của ${process.env.LOGO_NAME}`}>
                            <p>
                                {process.env.LOGO_NAME} ra đời với sứ mệnh cung cấp kiến thức chuyên sâu và đa dạng về công nghệ, đời sống, và các sản phẩm hữu ích. Chúng tôi không
                                chỉ là nơi để bạn tìm hiểu thông tin mà còn là nguồn cảm hứng giúp bạn đưa ra quyết định sáng suốt trong thế giới số ngày nay.
                            </p>
                        </BoxAboutSession>
